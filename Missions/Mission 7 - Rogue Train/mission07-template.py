...
def get_direction(line, train_position):
    station_1 = get_station_position(line, get_station_by_code(line, train_position[1]))
    station_2 = get_station_position(line, get_station_by_code(line, train_position[2]))
